// COLLEGE OLX. A logo, not a heading — never reuse this for page titles.
//
// Built to be the loudest thing in the masthead without breaking the one-
// crimson-per-region rule, because the logo IS the region's crimson:
//
//   COLLEGE  — Bangers, ink, with a hard crimson offset behind it. Zero blur,
//              so it reads as a misregistered second print pass, not a shadow.
//   OLX      — stamped into a crimson slab: ink border, hard ink offset, and
//              a couple of degrees of rotation so it sits on the page like it
//              was pressed there by hand.
//
// On hover the slab straightens and the offsets collapse — the same physical
// press as the Button. That is a user action, so it is allowed to animate.
